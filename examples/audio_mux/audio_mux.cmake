...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_audio_mux)
...
set(TARGET_NAME tile1_example_audio_mux)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_audio_mux tile0_example_audio_mux tile1_example_audio_mux 1)

#**********************
# Create run and debug targets
#**********************
create_run_target(example_audio_mux)
create_debug_target(example_audio_mux)
create_flash_app_target(example_audio_mux)
